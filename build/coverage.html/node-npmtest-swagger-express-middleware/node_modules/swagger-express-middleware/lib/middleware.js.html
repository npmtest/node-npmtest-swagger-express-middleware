...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-swagger-express-middleware/node_modules/swagger-express-middleware/lib/middleware.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-swagger-express-middleware/node_modules/swagger-express-middleware/lib/middleware.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-swagger-express-middleware/node_modules/swagger-express-middleware/lib/</a> &#187; middleware.js</div>
</div>
<div class="body">
...
function Middleware(sharedRouter) {
  sharedRouter = util.isExpressRouter(sharedRouter) ? sharedRouter : <span class="branch-1 cbranch-no" title="branch not covered" >undefined;</span>
&nbsp;
  var self = this;
...
&nbsp;
  ...
  this.files = function(router, options) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (arguments.length === 1 &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!util.isExpressRouter(router) </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >!util.isExpressRoutingOptions(router))</span> {
      // Shift arguments
<span class="cstat-no" title="statement not covered" >      options = router;</span>
<span class="cstat-no" title="statement not covered" >      router = sharedRouter;</span>
    }
&nbsp;
